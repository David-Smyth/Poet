...
//  Launch Energy
//
//  Created by David Smyth on 7/10/14.
//  Copyright (c) 2014 Millennium Space Systems. All rights reserved.
//
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    var applicationFilesDirectory: NSURL {
        // Returns the directory the application uses to store the Core Data store file. This code uses a directory named "com.millennium-space.Launch_Energy" in the user's Application Support directory.
        let fileManager = NSFileManager.defaultManager()
        let urls = fileManager.URLsForDirectory(.ApplicationSupportDirectory, inDomains: .UserDomainMask)
        let appSupportURL: AnyObject = urls[urls.endIndex - 1]
        return appSupportURL.URLByAppendingPathComponent("com.millennium-space.Launch_Energy")
    }
    ...
    var managedObjectModel: NSManagedObjectModel {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Launch_Energy", withExtension: "momd")
    ...
    var persistentStoreCoordinator: NSPersistentStoreCoordinator? {
        ...
        let url = applicationFilesDirectory.URLByAppendingPathComponent("Launch_Energy.storedata")
